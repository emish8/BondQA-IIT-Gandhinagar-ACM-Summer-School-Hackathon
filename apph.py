...
genai.configure(api_key='AIzaSyDx9kLslwGOzRjtNqoxoTk3T4aeYug-Tq8')
...
def get_vector_store(text_chunks):
    embeddings = GoogleGenerativeAIEmbeddings(model="models/embedding-001", google_api_key="AIzaSyDx9kLslwGOzRjtNqoxoTk3T4aeYug-Tq8")
    vector_store = FAISS.from_texts(text_chunks, embedding=embeddings)
    vector_store.save_local("faiss_index")

def get_conversational_chain():
    prompt_template = """ Answer the question about electoral bonds from the context.
    Answer in brief but solve the question step by step.
    Context:\n {context}\n
    Question: \n{question}\n
    Answer:
    """
